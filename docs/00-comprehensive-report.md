...
![건설·프롭테크 AX 사업 진입 논리](./assets/visualizations/ax-flat-visual-gpt-image-2.png)

<div className="doc-figure-caption">건설·프롭테크 AX 사업 진입 논리: 업무·데이터·운영 레이어를 비주얼 중심으로 표현</div>
