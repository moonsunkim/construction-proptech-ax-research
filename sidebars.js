      ...
      items: [
        {
          ...
          items: [
            ...
            {type: 'doc', id: 'budget-owner-buying-motion', label: 'Budget Owner & Buying Motion'},
            {type: 'doc', id: 'korea-why-now-research', label: 'Korea Why Now'},
            {type: 'doc', id: 'competitive-white-space-research', label: 'Competitive White Space'},
            {type: 'doc', id: 'ax-operating-layer-thesis', label: 'AX Operating Layer Thesis'},
          ],
        },
        {
          type: 'category',
