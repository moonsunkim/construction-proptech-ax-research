const sidebars = {
  researchSidebar: [
    ...
    {type: 'doc', id: 'comprehensive-report', label: '종합 분석'},
    {
      type: 'category',
      label: '리서치 데이터',
      collapsed: false,
      items: [
        {type: 'doc', id: 'wedge-ranking', label: '웨지 랭킹'},
        {type: 'doc', id: 'budget-owner-buying-motion', label: '예산 주체와 구매 여정'},
        {type: 'doc', id: 'korea-why-now-research', label: '한국, 왜 지금인가'},
        {type: 'doc', id: 'competitive-white-space-research', label: '경쟁 공백 영역'},
        {type: 'doc', id: 'ax-operating-layer-thesis', label: 'AX 운영 레이어 논리'},
        ...
        {type: 'doc', id: 'investor-thesis-market-map', label: '시장 진입 논리·시장 지도'},
      ],
    },
  ],
};
